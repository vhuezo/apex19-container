...
--application/themes/17
 
begin
 
    wwv_flow.g_flow_theme_id := 17;
null;
...
prompt  ......Page template 2209088750497356324
 
begin
 
wwv_flow_api.create_template (
  p_id => 2209088750497356324 + wwv_flow_api.g_id_offset
...
'  <link rel="icon" href="#WORKSPACE_IMAGES#telstra-icon.ico" type="image/x-icon">'||unistr('\000a')||
'  <link rel="shortcut icon" href="#WORKSPACE_IMAGES#telstra-icon.ico" type="image/x-icon">'||unistr('\000a')||
...
prompt  ......Page template 2209088941875356325
 
begin
 
wwv_flow_api.create_template (
  p_id => 2209088941875356325 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
, p_theme_id => wwv_flow.g_flow_theme_id
...
prompt  ......Page template 2209089244344356325
 
begin
 
wwv_flow_api.create_template (
  p_id => 2209089244344356325 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
, p_theme_id => wwv_flow.g_flow_theme_id
...
prompt  ......Page template 2209089541901356325
 
begin
 
wwv_flow_api.create_template (
  p_id => 2209089541901356325 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
, p_theme_id => wwv_flow.g_flow_theme_id
...
'#PAGE_JAVASCRIPT#'||unistr('\000a')||
'#HEAD#'||unistr('\000a')||
'  <link rel="stylesheet" href="#IMAGE_PREFIX#themes/theme_17/css/theme_4_2.css" type="text/css" />'||unistr('\000a')||
'  <!--[if IE]><link rel="stylesheet" href="#IMAGE_PREFIX#themes/theme_17/css/theme_4_0_ie.css" type="text/css" /><![endif]-->'||unistr('\000a')||
'  <!--[if IE 6]><link rel="stylesheet" href="#IMAGE_PREFIX#themes/theme_17/css/theme_4_0_ie6.css" type="text/css" /><![endif]-->'||unistr('\000a')||
'  <!--[if IE 7]><link rel="stylesheet" href="#IMAGE_PREFIX#themes/theme_17/css/theme_4_0_ie7.css" type="text/css" /><![endif]-->'||unistr('\000a')||
'</head>'||unistr('\000a')||
...
prompt  ......Page template 2209089846070356325
 
begin
 
wwv_flow_api.create_template (
  p_id => 2209089846070356325 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
, p_theme_id => wwv_flow.g_flow_theme_id
...
prompt  ......Page template 2209090158328356325
 
begin
 
wwv_flow_api.create_template (
  p_id => 2209090158328356325 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
, p_theme_id => wwv_flow.g_flow_theme_id
...
prompt  ......Page template 2209090454325356325
 
begin
 
wwv_flow_api.create_template (
  p_id => 2209090454325356325 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
, p_theme_id => wwv_flow.g_flow_theme_id
...
prompt  ......Page template 2209090746970356326
 
begin
 
wwv_flow_api.create_template (
  p_id => 2209090746970356326 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
, p_theme_id => wwv_flow.g_flow_theme_id
...
prompt  ......Page template 2209091040375356326
 
begin
 
wwv_flow_api.create_template (
  p_id => 2209091040375356326 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
, p_theme_id => wwv_flow.g_flow_theme_id
...
'<div id="footer"><div class="content">'||unistr('\000a')||
'<div id="customize">#CUSTOMIZE#</div>'||unistr('\000a')||
'<div class="app-version"></div>'||unistr('\000a')||
'<div class="clear"></div>'||unistr('\000a')||
'  #REGION_POSITION_05#'||unistr('\000a')||
'</div></div>'||unistr('\000a')||
'#FORM_CLOSE#'||unistr('\000a')||
...
prompt  ......Page template 2209091349631356326
 
begin
 
wwv_flow_api.create_template (
  p_id => 2209091349631356326 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
, p_theme_id => wwv_flow.g_flow_theme_id
 ,p_name => 'Popup'
 ,p_is_popup => false
...
prompt  ......Page template 2209091654173356326
 
begin
 
wwv_flow_api.create_template (
  p_id => 2209091654173356326 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
, p_theme_id => wwv_flow.g_flow_theme_id
...
prompt  ......Page template 2209091947611356326
 
begin
 
wwv_flow_api.create_template (
  p_id => 2209091947611356326 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
, p_theme_id => wwv_flow.g_flow_theme_id
...
prompt  ......Page template 2209092230613356326
 
begin
 
wwv_flow_api.create_template (
  p_id => 2209092230613356326 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
, p_theme_id => wwv_flow.g_flow_theme_id
...
prompt  ......Page template 2209092540006356326
 
begin
 
wwv_flow_api.create_template (
  p_id => 2209092540006356326 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
, p_theme_id => wwv_flow.g_flow_theme_id
...
prompt  ......Page template 2209092848697356327
 
begin
 
wwv_flow_api.create_template (
  p_id => 2209092848697356327 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
, p_theme_id => wwv_flow.g_flow_theme_id
...
prompt  ......Button Template 2209093155524356327
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2209093155524356327 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 2209093328204356327
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2209093328204356327 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 2209093541626356327
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2209093541626356327 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 2209093750901356327
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2209093750901356327 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
--application/shared_components/user_interface/templates/button/blue_custom
prompt  ......Button Template 2268150919744646631
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2268150919744646631 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template_name => 'blue custom'
 ,p_template => 
'<style = ''text/css''>'||unistr('\000a')||
'.btn-primary {'||unistr('\000a')||
'  color: #ffffff;'||unistr('\000a')||
'  text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25);'||unistr('\000a')||
'  background-color: #46ace1;'||unistr('\000a')||
'  *background-color: #46ace1;'||unistr('\000a')||
'  background-image: -moz-linear-gradient(top, #46ace1, #46ace1);'||unistr('\000a')||
'  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#0088cc), to(#0044cc));'||unistr('\000a')||
'  background-image: -webkit-linear-gradient(top, #0088cc, #0044cc);'||unistr('\000a')||
'  background-image: -o'||
'-linear-gradient(top, #0088cc, #0044cc);'||unistr('\000a')||
'  background-image: linear-gradient(to bottom, #0088cc, #0044cc);'||unistr('\000a')||
'  background-repeat: repeat-x;'||unistr('\000a')||
'  border-color: #0044cc #0044cc #002a80;'||unistr('\000a')||
'  border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.25);'||unistr('\000a')||
'  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=''#ff0088cc'', endColorstr=''#ff0044cc'', GradientType=0);'||unistr('\000a')||
'  filter: progid:DXImage'||
'Transform.Microsoft.gradient(enabled=false);'||unistr('\000a')||
'}'||unistr('\000a')||
''||unistr('\000a')||
'.btn-primary:hover,'||unistr('\000a')||
'.btn-primary:focus,'||unistr('\000a')||
'.btn-primary:active,'||unistr('\000a')||
'.btn-primary.active,'||unistr('\000a')||
'.btn-primary.disabled,'||unistr('\000a')||
'.btn-primary[disabled] {'||unistr('\000a')||
'  color: #ffffff;'||unistr('\000a')||
'  background-color: #0044cc;'||unistr('\000a')||
'  *background-color: #003bb3;'||unistr('\000a')||
'}'||unistr('\000a')||
''||unistr('\000a')||
'.btn-primary:active,'||unistr('\000a')||
'.btn-primary.active {'||unistr('\000a')||
'  background-color: #003399 \9;'||unistr('\000a')||
'}'||unistr('\000a')||
''||unistr('\000a')||
'</style>'||unistr('\000a')||
''||unistr('\000a')||
'<button value="#LABEL#" onclick="#JAVASCRIPT#" class="'||
'btn-primary" type="button" #BUTTON_ATTRIBUTES# id="#BUTTON_ID#">'||unistr('\000a')||
'  <span>#LABEL#</span>'||unistr('\000a')||
'</button>'
 ,p_hot_template => 
'<button value="#LABEL#" onclick="#JAVASCRIPT#" class="button-alt1" type="button" #BUTTON_ATTRIBUTES# id="#BUTTON_ID#">'||unistr('\000a')||
...
--application/shared_components/user_interface/templates/button/green_custom
prompt  ......Button Template 2307396131138779818
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2307396131138779818 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template_name => 'green custom'
 ,p_template => 
'<style = ''text/css''>'||unistr('\000a')||
'.btn-primary1 {'||unistr('\000a')||
'  color: #ffffff;'||unistr('\000a')||
'  text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25);'||unistr('\000a')||
'  background-color: #98c73b;'||unistr('\000a')||
'  *background-color: #98c73b;'||unistr('\000a')||
'  background-image: -moz-linear-gradient(top, #98c73b, #98c73b);'||unistr('\000a')||
'  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#98c73b), to(#98c73b));'||unistr('\000a')||
'  background-image: -webkit-linear-gradient(top, #0088cc, #98c73b);'||unistr('\000a')||
'  background-image: -'||
'o-linear-gradient(top, #98c73b, #98c73b);'||unistr('\000a')||
'  background-image: linear-gradient(to bottom, #98c73b, #98c73b);'||unistr('\000a')||
'  background-repeat: repeat-x;'||unistr('\000a')||
'  border-color: #98c73b #98c73b #98c73b;'||unistr('\000a')||
'  border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.25);'||unistr('\000a')||
'  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=''#98c73b'', endColorstr=''#98c73b'', GradientType=0);'||unistr('\000a')||
'  filter: progid:DXImageTra'||
'nsform.Microsoft.gradient(enabled=false);'||unistr('\000a')||
'}'||unistr('\000a')||
''||unistr('\000a')||
'.btn-primary1:hover,'||unistr('\000a')||
'.btn-primary1:focus,'||unistr('\000a')||
'.btn-primary1:active,'||unistr('\000a')||
'.btn-primary1.active,'||unistr('\000a')||
'.btn-primary1.disabled,'||unistr('\000a')||
'.btn-primary1[disabled] {'||unistr('\000a')||
'  color: #ffffff;'||unistr('\000a')||
'  background-color: #0B6121;'||unistr('\000a')||
'  *background-color: #0B6121;'||unistr('\000a')||
'}'||unistr('\000a')||
''||unistr('\000a')||
'.btn-primary1:active,'||unistr('\000a')||
'.btn-primary1.active {'||unistr('\000a')||
'  background-color: #98c73b \9;'||unistr('\000a')||
'}'||unistr('\000a')||
''||unistr('\000a')||
'</style>'||unistr('\000a')||
''||unistr('\000a')||
'<button value="#LABEL#" onclick="#JAVASCRIPT#" cl'||
'ass="btn-primary1" type="button" #BUTTON_ATTRIBUTES# id="#BUTTON_ID#">'||unistr('\000a')||
'  <span>#LABEL#</span>'||unistr('\000a')||
'</button>'
 ,p_hot_template => 
'<button value="#LABEL#" onclick="#JAVASCRIPT#" class="button-alt1" type="button" #BUTTON_ATTRIBUTES# id="#BUTTON_ID#">'||unistr('\000a')||
...
--application/shared_components/user_interface/templates/button/orange_custom
prompt  ......Button Template 2307396402526781066
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2307396402526781066 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template_name => 'orange custom'
 ,p_template => 
'<style = ''text/css''>'||unistr('\000a')||
'.btn-primary2 {'||unistr('\000a')||
'  color: #ffffff;'||unistr('\000a')||
'  text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25);'||unistr('\000a')||
'  background-color: #ef7d00;'||unistr('\000a')||
'  *background-color: #ef7d00;'||unistr('\000a')||
'  background-image: -moz-linear-gradient(top, #ef7d00, #ef7d00);'||unistr('\000a')||
'  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#ef7d00), to(#ef7d00));'||unistr('\000a')||
'  background-image: -webkit-linear-gradient(top, #ef7d00, #ef7d00);'||unistr('\000a')||
'  background-image: -'||
'o-linear-gradient(top, #ef7d00, #ef7d00);'||unistr('\000a')||
'  background-image: linear-gradient(to bottom, #ef7d00, #ef7d00);'||unistr('\000a')||
'  background-repeat: repeat-x;'||unistr('\000a')||
'  border-color: #ef7d00 #ef7d00 #ef7d00;'||unistr('\000a')||
'  border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.25);'||unistr('\000a')||
'  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=''#ff0088cc'', endColorstr=''#ff0044cc'', GradientType=0);'||unistr('\000a')||
'  filter: progid:DXImag'||
'eTransform.Microsoft.gradient(enabled=false);'||unistr('\000a')||
'}'||unistr('\000a')||
''||unistr('\000a')||
'.btn-primary2:hover,'||unistr('\000a')||
'.btn-primary2:focus,'||unistr('\000a')||
'.btn-primary2:active,'||unistr('\000a')||
'.btn-primary2.active,'||unistr('\000a')||
'.btn-primary2.disabled,'||unistr('\000a')||
'.btn-primary2[disabled] {'||unistr('\000a')||
'  color: #ffffff;'||unistr('\000a')||
'  background-color: #8A4B08;'||unistr('\000a')||
'  *background-color: #8A4B08;'||unistr('\000a')||
'}'||unistr('\000a')||
''||unistr('\000a')||
'.btn-primary2:active,'||unistr('\000a')||
'.btn-primary2.active {'||unistr('\000a')||
'  background-color: #ef7d00 \9;'||unistr('\000a')||
'}'||unistr('\000a')||
''||unistr('\000a')||
'</style>'||unistr('\000a')||
''||unistr('\000a')||
'<button value="#LABEL#" onclick="#JAVASCRIPT#'||
'" class="btn-primary2" type="button" #BUTTON_ATTRIBUTES# id="#BUTTON_ID#">'||unistr('\000a')||
'  <span>#LABEL#</span>'||unistr('\000a')||
'</button>'
 ,p_hot_template => 
'<button value="#LABEL#" onclick="#JAVASCRIPT#" class="button-alt1" type="button" #BUTTON_ATTRIBUTES# id="#BUTTON_ID#">'||unistr('\000a')||
...
--application/shared_components/user_interface/templates/button/pink_custom
prompt  ......Button Template 2309325930954394331
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2309325930954394331 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template_name => 'pink custom'
 ,p_template => 
'<style = ''text/css''>'||unistr('\000a')||
'.btn-primary3 {'||unistr('\000a')||
'  color: #ffffff;'||unistr('\000a')||
'  text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25);'||unistr('\000a')||
'  background-color: #e8308a;'||unistr('\000a')||
'  *background-color: #e8308a;'||unistr('\000a')||
'  background-image: -moz-linear-gradient(top, #e8308a, #e8308a);'||unistr('\000a')||
'  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#e8308a), to(#e8308a));'||unistr('\000a')||
'  background-image: -webkit-linear-gradient(top, #e8308a, #e8308a);'||unistr('\000a')||
'  background-image: -'||
'o-linear-gradient(top, #e8308a, #e8308a);'||unistr('\000a')||
'  background-image: linear-gradient(to bottom, #e8308a, #e8308a);'||unistr('\000a')||
'  background-repeat: repeat-x;'||unistr('\000a')||
'  border-color: #e8308a #e8308a #e8308a ;'||unistr('\000a')||
'  border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.25);'||unistr('\000a')||
'  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=''#ff0088cc'', endColorstr=''#ff0044cc'', GradientType=0);'||unistr('\000a')||
'  filter: progid:DXIma'||
'geTransform.Microsoft.gradient(enabled=false);'||unistr('\000a')||
'}'||unistr('\000a')||
''||unistr('\000a')||
'.btn-primary3:hover,'||unistr('\000a')||
'.btn-primary3:focus,'||unistr('\000a')||
'.btn-primary3:active,'||unistr('\000a')||
'.btn-primary3.active,'||unistr('\000a')||
'.btn-primary3.disabled,'||unistr('\000a')||
'.btn-primary3[disabled] {'||unistr('\000a')||
'  color: #ffffff;'||unistr('\000a')||
'  background-color: #B40486;'||unistr('\000a')||
'  *background-color: #B40486;'||unistr('\000a')||
'}'||unistr('\000a')||
''||unistr('\000a')||
'.btn-primary3:active,'||unistr('\000a')||
...
''||unistr('\000a')||
'<button value="#LABEL#" onclick="#JAVASCRIPT'||
'#" class="btn-primary3" type="button" #BUTTON_ATTRIBUTES# id="#BUTTON_ID#">'||unistr('\000a')||
'  <span>#LABEL#</span>'||unistr('\000a')||
'</button>'
 ,p_hot_template => 
'<button value="#LABEL#" onclick="#JAVASCRIPT#" class="button-alt1" type="button" #BUTTON_ATTRIBUTES# id="#BUTTON_ID#">'||unistr('\000a')||
...
--application/shared_components/user_interface/templates/button/purple_custom
prompt  ......Button Template 2766499714504100176
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2766499714504100176 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template_name => 'purple custom'
 ,p_template => 
'<style = ''text/css''>'||unistr('\000a')||
'.btn-primary4 {'||unistr('\000a')||
'  color: #ffffff;'||unistr('\000a')||
'  text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25);'||unistr('\000a')||
'  background-color: #9a8ec4;'||unistr('\000a')||
'  *background-color: #9a8ec4;'||unistr('\000a')||
'  background-image: -moz-linear-gradient(top, #9a8ec4, #9a8ec4);'||unistr('\000a')||
'  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#0088cc), to(#0044cc));'||unistr('\000a')||
'  background-image: -webkit-linear-gradient(top, #0088cc, #0044cc);'||unistr('\000a')||
'  background-image: -'||
'o-linear-gradient(top, #0088cc, #0044cc);'||unistr('\000a')||
'  background-image: linear-gradient(to bottom, #0088cc, #0044cc);'||unistr('\000a')||
'  background-repeat: repeat-x;'||unistr('\000a')||
'  border-color: #0044cc #0044cc #002a80;'||unistr('\000a')||
'  border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.25);'||unistr('\000a')||
...
'}'||unistr('\000a')||
''||unistr('\000a')||
'.btn-primary4:hover,'||unistr('\000a')||
'.btn-primary4:focus,'||unistr('\000a')||
'.btn-primary4:active,'||unistr('\000a')||
'.btn-primary4.active,'||unistr('\000a')||
'.btn-primary4.disabled,'||unistr('\000a')||
'.btn-primary4[disabled] {'||unistr('\000a')||
'  color: #ffffff;'||unistr('\000a')||
'  background-color: #0044cc;'||unistr('\000a')||
'  *background-color: #003bb3;'||unistr('\000a')||
...
''||unistr('\000a')||
'<button value="#LABEL#" onclick="#JAVASCRIPT#'||
'" class="btn-primary4" type="button" #BUTTON_ATTRIBUTES# id="#BUTTON_ID#">'||unistr('\000a')||
'  <span>#LABEL#</span>'||unistr('\000a')||
'</button>'
 ,p_hot_template => 
'<button value="#LABEL#" onclick="#JAVASCRIPT#" class="button-alt1" type="button" #BUTTON_ATTRIBUTES# id="#BUTTON_ID#">'||unistr('\000a')||
...
--
--application/shared_components/user_interface/templates/region/borderless_region2
prompt  ......region template 2056113000034197843
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2056113000034197843 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
'  <div class="bl-top1">'||unistr('\000a')||
...
'</div>'||unistr('\000a')||
'<div class="clear"></div>'
 ,p_page_plug_template_name => 'Borderless Region2'
,p_theme_id => wwv_flow.g_flow_theme_id
 ,p_theme_class_id => 7
...
prompt  ......region template 2209093942817356327
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209093942817356327 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2209094236058356327
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209094236058356327 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2209094548313356328
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209094548313356328 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2209094837269356328
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209094837269356328 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2209095132131356328
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209095132131356328 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="rounded-corner-region-blank" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2209095451265356328
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209095451265356328 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2209095732392356328
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209095732392356328 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2209096036501356328
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209096036501356328 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2209096350120356328
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209096350120356328 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="hide-show-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
'  <div class="hide-show-top">'||unistr('\000a')||
'    <div class="hide-show-title"><a href="javascript:hideShow(''region#REGION_SEQUENCE_ID#'',''shIMG#REGION_SEQUENCE_ID#'',''#IMAGE_PREFIX#themes/theme_20/collapse_plus.gif'',''#IMAGE_PREFIX#themes/theme_20/collapse_minus.gif'');" class="t1HideandShowRegionLink"><img src="#IMAGE_PREFIX#themes/theme_20/'||
'collapse_plus.gif" '||unistr('\000a')||
...
prompt  ......region template 2209096634815356328
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209096634815356328 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2209096929655356328
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209096929655356328 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2209097239365356329
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209097239365356329 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2209097537487356329
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209097537487356329 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2209097835757356331
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209097835757356331 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2209098153393356331
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209098153393356331 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2209098456323356331
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209098456323356331 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2209098754492356331
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209098754492356331 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2209099050966356331
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209099050966356331 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2209099353544356331
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209099353544356331 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="rounded-corner-region-alt" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2209099643386356331
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209099643386356331 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2209099955944356332
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209099955944356332 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="sidebar-region">'||unistr('\000a')||
...
prompt  ......region template 2209100237305356332
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209100237305356332 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="rounded-corner-region-blank" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2209100555104356332
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209100555104356332 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2209100855610356332
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2209100855610356332 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="rounded-corner-region-wizard">'||unistr('\000a')||
...
--application/shared_components/user_interface/templates/region/hide_and_show_region_custom
prompt  ......region template 2305408804768166211
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2305408804768166211 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="hide-show-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
'  <div class="hide-show-top">'||unistr('\000a')||
'    <div class="hide-show-title"><a href="javascript:hideShow(''region#REGION_SEQUENCE_ID#'',''shIMG#REGION_SEQUENCE_ID#'',''#WORKSPACE_IMAGES#show_app.png'',''#WORKSPACE_IMAGES#hide_app.png'');" class="t1HideandShowRegionLink"><img src="#WORKSPACE_IMAGES#show_app.png" '||unistr('\000a')||
'  id="shIMG#REGION_SEQUENCE_ID#"'||
' alt="" /></a></div>'||unistr('\000a')||
'    <div class="hide-show-buttons">#CLOSE##PREVIOUS##NEXT##DELETE##EDIT##CHANGE##CREATE##CREATE2##EXPAND##COPY##HELP#</div>'||unistr('\000a')||
'  </div>'||unistr('\000a')||
'<div class="hide" id="region#REGION_SEQUENCE_ID#" style="float:left;">#BODY#</div>'||unistr('\000a')||
'</div>'
 ,p_page_plug_template_name => 'Hide and Show Region Custom'
,p_theme_id => wwv_flow.g_flow_theme_id
 ,p_theme_class_id => 1
 ,p_default_label_alignment => 'RIGHT'
 ,p_default_field_alignment => 'LEFT'
...
--application/shared_components/user_interface/templates/region/hide_and_show_region_refine_details
prompt  ......region template 2306932918279979278
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2306932918279979278 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="hide-show-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
'  <div class="hide-show-top">'||unistr('\000a')||
'    <div class="hide-show-title"><a href="javascript:hideShow(''region#REGION_SEQUENCE_ID#'',''shIMG#REGION_SEQUENCE_ID#'',''#WORKSPACE_IMAGES#refine-details.png'',''#WORKSPACE_IMAGES#refine-details-clicked.png'');" class="t1HideandShowRegionLink"><img src="#WORKSPACE_IMAGES#refine-details.png" '||unistr('\000a')||
'  id="'||
'shIMG#REGION_SEQUENCE_ID#" alt="" /></a></div>'||unistr('\000a')||
'    <div class="hide-show-buttons">#CLOSE##PREVIOUS##NEXT##DELETE##EDIT##CHANGE##CREATE##CREATE2##EXPAND##COPY##HELP#</div>'||unistr('\000a')||
'  </div>'||unistr('\000a')||
'<div class="hide" id="region#REGION_SEQUENCE_ID#" style="float:left;">#BODY#</div>'||unistr('\000a')||
'</div>'
 ,p_page_plug_template_name => 'Hide and Show Region - Refine Details'
,p_theme_id => wwv_flow.g_flow_theme_id
 ,p_theme_class_id => 1
 ,p_default_label_alignment => 'RIGHT'
 ,p_default_field_alignment => 'LEFT'
...
--application/shared_components/user_interface/templates/region/hide_and_show_region_refine_host_osi
prompt  ......region template 2306961012953318420
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2306961012953318420 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="hide-show-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
'  <div class="hide-show-top">'||unistr('\000a')||
'    <div class="hide-show-title"><a href="javascript:hideShow(''region#REGION_SEQUENCE_ID#'',''shIMG#REGION_SEQUENCE_ID#'',''#WORKSPACE_IMAGES#refine-hostosi.png'',''#WORKSPACE_IMAGES#refine-hostosi-clicked.png'');" class="t1HideandShowRegionLink"><img src="#WORKSPACE_IMAGES#refine-hostosi.png" '||unistr('\000a')||
'  id="'||
'shIMG#REGION_SEQUENCE_ID#" alt="" /></a></div>'||unistr('\000a')||
'    <div class="hide-show-buttons">#CLOSE##PREVIOUS##NEXT##DELETE##EDIT##CHANGE##CREATE##CREATE2##EXPAND##COPY##HELP#</div>'||unistr('\000a')||
'  </div>'||unistr('\000a')||
'<div class="hide" id="region#REGION_SEQUENCE_ID#" style="float:left;">#BODY#</div>'||unistr('\000a')||
'</div>'
 ,p_page_plug_template_name => 'Hide and Show Region - Refine host osi'
,p_theme_id => wwv_flow.g_flow_theme_id
 ,p_theme_class_id => 1
 ,p_default_label_alignment => 'RIGHT'
 ,p_default_field_alignment => 'LEFT'
...
--application/shared_components/user_interface/templates/region/hide_and_show_region_refine_utilisation
prompt  ......region template 2306961316763319541
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2306961316763319541 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="hide-show-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
'  <div class="hide-show-top">'||unistr('\000a')||
'    <div class="hide-show-title"><a href="javascript:hideShow(''region#REGION_SEQUENCE_ID#'',''shIMG#REGION_SEQUENCE_ID#'',''#WORKSPACE_IMAGES#refine-utilisation.png'',''#WORKSPACE_IMAGES#refine-utilisation-clicked.png'');" class="t1HideandShowRegionLink"><img src="#WORKSPACE_IMAGES#refine-utilisation.'||
'png" '||unistr('\000a')||
...
'<div class="hide" id="region#REGION_SEQUENCE_ID#" style="float:left;">#BODY#</div>'||unistr('\000a')||
'</div>'
 ,p_page_plug_template_name => 'Hide and Show Region - Refine utilisation'
,p_theme_id => wwv_flow.g_flow_theme_id
 ,p_theme_class_id => 1
 ,p_default_label_alignment => 'RIGHT'
 ,p_default_field_alignment => 'LEFT'
...
--application/shared_components/user_interface/templates/region/hide_and_show_region_refine_parameters
prompt  ......region template 2306961520572320671
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2306961520572320671 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="hide-show-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
'  <div class="hide-show-top">'||unistr('\000a')||
'    <div class="hide-show-title"><a href="javascript:hideShow(''region#REGION_SEQUENCE_ID#'',''shIMG#REGION_SEQUENCE_ID#'',''#WORKSPACE_IMAGES#refine-parameters.png'',''#WORKSPACE_IMAGES#refine-parameters-clicked.png'');" class="t1HideandShowRegionLink"><img src="#WORKSPACE_IMAGES#refine-parameters.png'||
'" '||unistr('\000a')||
'  id="shIMG#REGION_SEQUENCE_ID#" alt="" /></a></div>'||unistr('\000a')||
'    <div class="hide-show-buttons">#CLOSE##PREVIOUS##NEXT##DELETE##EDIT##CHANGE##CREATE##CREATE2##EXPAND##COPY##HELP#</div>'||unistr('\000a')||
'  </div>'||unistr('\000a')||
'<div class="hide" id="region#REGION_SEQUENCE_ID#" style="float:left;">#BODY#</div>'||unistr('\000a')||
'</div>'
 ,p_page_plug_template_name => 'Hide and Show Region - Refine parameters'
,p_theme_id => wwv_flow.g_flow_theme_id
 ,p_theme_class_id => 1
 ,p_default_label_alignment => 'RIGHT'
 ,p_default_field_alignment => 'LEFT'
...
--application/shared_components/user_interface/templates/region/reports_region_alternative_no_title
prompt  ......region template 2320317217689037824
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2320317217689037824 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="rounded-corner-region-alt" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
'    <div class="rc-buttons">#CLOSE##PREVIOUS##NEXT##DELETE##EDIT##CHANGE##CREATE##CREATE2##EXPAND##COPY##HELP#</div>'||unistr('\000a')||
'  </div></div>'||unistr('\000a')||
'  <div class="rc-body"><div class="rc-body-r"><div class="rc-content-main">#BODY#<div class="clear"></div>'||unistr('\000a')||
'<div class="clear"></d'||
'iv>'||unistr('\000a')||
'</div>'||unistr('\000a')||
'</div></div>'||unistr('\000a')||
'  <div class="rc-bottom"><div class="rc-bottom-r"></div></div>'||unistr('\000a')||
'</div>'
 ,p_page_plug_template_name => 'Reports Region, Alternative No Title'
 ,p_plug_table_bgcolor => '#ffffff'
,p_theme_id => wwv_flow.g_flow_theme_id
 ,p_theme_class_id => 10
 ,p_plug_heading_bgcolor => '#ffffff'
...
--application/shared_components/user_interface/templates/region/navigation_region_alternative_1_with_title
prompt  ......region template 2338471306347294117
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2338471306347294117 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="navigation-region-alt" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
'    <h3>#TITLE#</h3>'||unistr('\000a')||
'  <div>'||unistr('\000a')||
'    #BODY#'||unistr('\000a')||
'  </div>'||unistr('\000a')||
'</div>'
 ,p_page_plug_template_name => 'Navigation Region, Alternative 1 with title'
,p_theme_id => wwv_flow.g_flow_theme_id
 ,p_theme_class_id => 16
 ,p_default_label_alignment => 'RIGHT'
 ,p_default_field_alignment => 'LEFT'
...
--application/shared_components/user_interface/templates/region/hide_and_show_region_indented
prompt  ......region template 2347125730292515206
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2347125730292515206 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="hide-show-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
'  <div class="hide-show-top">'||unistr('\000a')||
'    <div class="hide-show-title">&nbsp;&nbsp;&nbsp;&nbsp<a href="javascript:hideShow(''region#REGION_SEQUENCE_ID#'',''shIMG#REGION_SEQUENCE_ID#'',''#IMAGE_PREFIX#themes/theme_20/collapse_plus.gif'',''#IMAGE_PREFIX#themes/theme_20/collapse_minus.gif'');" class="t1HideandShowRegionLink"><img src="#IMAGE_'||
'PREFIX#themes/theme_20/collapse_plus.gif" '||unistr('\000a')||
'  id="shIMG#REGION_SEQUENCE_ID#" alt="" /></a> #TITLE# </div>'||unistr('\000a')||
'    <div class="hide-show-buttons" >#CLOSE##PREVIOUS##NEXT##DELETE##EDIT##CHANGE##CREATE##CREATE2##EXPAND##COPY##HELP#</div>'||unistr('\000a')||
'  </div>'||unistr('\000a')||
'<div class="hide" id="region#REGION_SEQUENCE_ID#" style="float:left;">#BODY#</div>'||unistr('\000a')||
'</div>'
 ,p_page_plug_template_name => 'Hide and Show Region - Indented'
,p_theme_id => wwv_flow.g_flow_theme_id
 ,p_theme_class_id => 1
 ,p_default_label_alignment => 'RIGHT'
 ,p_default_field_alignment => 'LEFT'
...
--application/shared_components/user_interface/templates/region/side_by_side_subregion
prompt  ......region template 2854172119100205868
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2854172119100205868 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
''||unistr('\000a')||
'  <div class="rc-gray-top">'||unistr('\000a')||
'  	<div class="rc-gray-top-r">'||unistr('\000a')||
''||unistr('\000a')||
'    	<div class="rc-title">#TITLE#</div>'||unistr('\000a')||
''||unistr('\000a')||
'    	<div class="rc-buttons">#CLOSE##PREVIOUS##NEXT##DELETE##EDIT##CHANGE##CREATE##CREATE2##EXPAND##COPY##HELP#</div>'||unistr('\000a')||
...
'px; float: left;">#BODY#'||unistr('\000a')||
...
'  '||unistr('\000a')||
'  <div class="rc-bottom">'||unistr('\000a')||
'  	<div class="rc-bottom-r">'||unistr('\000a')||
'  	</div>'||unistr('\000a')||
'  </div>'||unistr('\000a')||
'  '||unistr('\000a')||
'</div> '||unistr('\000a')||
''
 ,p_sub_plug_template => '<div style="float: left; width: 380px;">'||unistr('\000a')||
'  #SUB_REGION#'||unistr('\000a')||
'</div>'
 ,p_page_plug_template_name => 'Side by side subregion'
,p_theme_id => wwv_flow.g_flow_theme_id
 ,p_theme_class_id => 0
 ,p_default_label_alignment => 'RIGHT'
 ,p_default_field_alignment => 'LEFT'
...
wwv_flow_api.create_plug_tmpl_display_point (
  p_id => 64922401229306 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plug_template_id => 2854172119100205868 + wwv_flow_api.g_id_offset
 ,p_name => 'Body'
 ,p_placeholder => 'BODY'
 ,p_has_grid_support => false
 ,p_component_comment => 'Automatically generated during migration'
  );
null;
...
prompt  ......region template 3254199415563917524
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 3254199415563917524 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
'  <div class="bl-top" style="background-color:#EEEE22">'||unistr('\000a')||
'    <div class="bl-title" style="padding:5px;">#TITLE#</div>'||unistr('\000a')||
'    <div class="bl-buttons">#CLOSE##PREVIOUS##NEXT##DELETE##EDIT##CHANGE##CREATE##CREATE2##EXPAND##COPY##HELP#</div>'||unistr('\000a')||
'  </div>'||unistr('\000a')||
'  <div class="bl-body" style="background-color:#C80006; color:#FFFFFF">#BODY#</di'||
'v>'||unistr('\000a')||
'</div>'||unistr('\000a')||
'<div class="clear"></div>'
...
prompt  ......list template 2209101133357356332
...
wwv_flow_api.create_list_template (
  p_id=>2209101133357356332 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 2209101450561356332
...
wwv_flow_api.create_list_template (
  p_id=>2209101450561356332 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2209101736506356332
...
wwv_flow_api.create_list_template (
  p_id=>2209101736506356332 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2209102053784356333
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2209102053784356333 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2209102327633356333
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2209102327633356333 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2209102643203356333
...
wwv_flow_api.create_list_template (
  p_id=>2209102643203356333 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2209102942564356333
...
wwv_flow_api.create_list_template (
  p_id=>2209102942564356333 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2209103251400356333
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2209103251400356333 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2209103556305356333
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2209103556305356333 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2209103849017356333
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2209103849017356333 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2209104127135356334
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2209104127135356334 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2209104427450356334
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2209104427450356334 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2209104748527356334
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2209104748527356334 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2209105057277356334
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2209105057277356334 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2209105351184356334
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2209105351184356334 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 2209105630002356334
...
wwv_flow_api.create_row_template (
  p_id=> 2209105630002356334 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2209106128446356334
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2209106128446356334 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2209106642377356335
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2209106642377356335 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2209107136492356335
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2209107136492356335 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2209107627178356335
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2209107627178356335 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2209107950316356335
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2209107950316356335 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2209108441389356337
...
c2:=c2||'<td class="dataalt"#ALIGNMENT#>#COLUMN_VALUE#</td>'||unistr('\000a')||
'';

c3 := null;
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2209108441389356337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2209108928349356337
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2209108928349356337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2209109228780356337
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2209109228780356337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2209109527698356337
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2209109527698356337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--application/shared_components/user_interface/templates/report/standard_variable_column_width
prompt  ......report template 2307601214430494146
...
declare
  ...
  c4 varchar2(32767) := null;
begin
c1:=c1||'<td id="#COLUMN_HEADER_NAME#" class="data"#ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>';

c2:=c2||'<td id="#COLUMN_HEADER_NAME#" class="dataalt"#ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>';

c3 := null;
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2307601214430494146 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_row_template_name=> 'Standard - Variable Column Width',
  p_row_template1=> c1,
  p_row_template_condition1=> '',
  p_row_template2=> c2,
  p_row_template_condition2=> '',
...
wwv_flow_api.create_row_template_patch (
  p_id => 2307601214430494146 + wwv_flow_api.g_id_offset,
  p_row_template_before_first =>'<tbod>'||unistr('\000a')||
'<tr #HIGHLIGHT_ROW#>',
  p_row_template_after_last =>'</tr>'||unistr('\000a')||
'</tbod>');
exception when others then null;
...
prompt  ......label template 2209109857361356337
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 2209109857361356337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 2209109936441356337
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 2209109936441356337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 2209110035180356337
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 2209110035180356337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 2209110141432356337
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 2209110141432356337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 2209110241261356337
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 2209110241261356337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 2209110346790356337
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 2209110346790356337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 2209110441828356337
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 2209110441828356337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 2209111130537356338
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 2209111130537356338 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 2209110556332356337
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 2209110556332356337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 2209110727622356337
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 2209110727622356337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 2209110957253356338
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 2209110957253356338 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 2209111344406356338
begin
wwv_flow_api.create_theme (
  p_id =>2209111344406356338 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => wwv_flow.g_flow_theme_id,
  p_theme_name=>'Sapphire',
  p_ui_type_name=>'DESKTOP',
  p_is_locked=>false,
  p_default_page_template=>2209091040375356326 + wwv_flow_api.g_id_offset,
  p_error_template=>2209089846070356325 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=>2209091654173356326 + wwv_flow_api.g_id_offset,
  p_breadcrumb_display_point=>'REGION_POSITION_01',
  p_sidebar_display_point=>'REGION_POSITION_02',
  p_login_template=>2209088750497356324 + wwv_flow_api.g_id_offset,
  p_default_button_template=>2209093155524356327 + wwv_flow_api.g_id_offset,
  p_default_region_template=>2209098754492356331 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>2209095732392356328 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>2209096036501356328 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>2209098754492356331 + wwv_flow_api.g_id_offset,
  p_default_tabform_template=>2209098754492356331 + wwv_flow_api.g_id_offset,
  p_default_wizard_template=>2209100555104356332 + wwv_flow_api.g_id_offset,
  p_default_menur_template=>2209094548313356328 + wwv_flow_api.g_id_offset,
  p_default_listr_template=>2209095451265356328 + wwv_flow_api.g_id_offset,
  p_default_irr_template=>2209097537487356329 + wwv_flow_api.g_id_offset,
  p_default_report_template   =>2209107950316356335 + wwv_flow_api.g_id_offset,
  p_default_label_template=>2209110035180356337 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>2209110346790356337 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>2209110556332356337 + wwv_flow_api.g_id_offset,
  p_default_list_template=>2209104427450356334 + wwv_flow_api.g_id_offset,
  p_default_option_label=>2209110035180356337 + wwv_flow_api.g_id_offset,
  ...
  p_default_required_label=>2209110241261356337 + wwv_flow_api.g_id_offset);
end;
/
